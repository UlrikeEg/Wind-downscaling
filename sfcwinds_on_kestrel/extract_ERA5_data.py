...
mpirun -n 16 python3 /home/uegerer/sfcwinds/sfcwinds_on_kestrel/extract_ERA5_data.py
mpirun --use-hwthread-cpus -n 16 python3 /home/uegerer/sfcwinds/sfcwinds_on_kestrel/extract_ERA5_data.py
...
for year in years:
    year_files = [f for f in good_files if f"_{year}_" in f]
    if not year_files:
        continue
